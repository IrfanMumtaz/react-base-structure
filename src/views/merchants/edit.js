        ...
        fetch(`${config.base_url}v1/merchant/${id}`, requestOptions)
            ...
            .then((response) => {
                if (response.success === true) {
                    ...
                    formValues.s_phone = formValues.secondary_contacts[0]
                        ? formValues.secondary_contacts[0].s_phone
                        : null;
                    formValues.s_email = formValues.secondary_contacts[0]
                        ? formValues.secondary_contacts[0].s_email
                        : null;
